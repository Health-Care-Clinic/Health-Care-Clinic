...
UPDATE "Medicines" SET "Price" = 4.5
WHERE "Id" = 1;

UPDATE "Medicines" SET "Price" = 5.0
WHERE "Id" = 2;

UPDATE "Medicines" SET "Price" = 5.25
WHERE "Id" = 3;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20211219180637_TenderMigration', '5.0.11');

COMMIT;

START TRANSACTION;

ALTER TABLE "Medicines" ADD "TenderId" integer NULL;

CREATE TABLE "Tenders" (
    "Id" integer GENERATED BY DEFAULT AS IDENTITY,
    "ForeignId" integer NOT NULL,
    "TenderResponseDescription" text NULL,
    "IsWinningBidChosen" boolean NOT NULL,
    CONSTRAINT "PK_Tenders" PRIMARY KEY ("Id")
);

CREATE INDEX "IX_Medicines_TenderId" ON "Medicines" ("TenderId");

ALTER TABLE "Medicines" ADD CONSTRAINT "FK_Medicines_Tenders_TenderId" FOREIGN KEY ("TenderId") REFERENCES "Tenders" ("Id") ON DELETE RESTRICT;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20211228170503_Tender2', '5.0.11');
