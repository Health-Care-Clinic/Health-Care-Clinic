    ...
    public class WorkDayShiftTests
    {
        ...
        public void Add_work_day_shift(DateTime shiftStartTime, DateTime shiftEndTime, bool added)
        {
            ...
            using (var context = new HospitalDbContext(options))
            {
                ...
                bool shiftAdded = workDayShiftService.AddWorkDayShift(new WorkDayShift { Id = 3, Name = "Third", WorkHour = new WorkHour(shiftStartTime, shiftEndTime )});
                ClearStubRepository(context);
        ...
        public void Edit_work_day_shift(DateTime shiftStartTime, DateTime shiftEndTime, bool edited)
        {
            ...
            using (var context = new HospitalDbContext(options))
            {
                ...
                bool shiftEdited = workDayShiftService.EditWorkDayShift(new WorkDayShift { Id = 1, Name = "Third", WorkHour = new WorkHour(shiftStartTime, shiftEndTime) });
                ClearStubRepository(context);
