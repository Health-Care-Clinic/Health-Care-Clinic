...
namespace HospitalIntegrationTests.Graphical_editor
{
    public class TransfersTests
    {
        ...
        public void Add_new_transfer()
        {
            ...
            Transfer transfer = new Transfer(20, new Equipment("Bed", 5), 1, 2, new DateTime(2021, 11, 28, 9, 0, 0), 60);
        ...
        public void Cancel_transfer()
        {
            ...
            transferService.Add(new Transfer(20, new Equipment("Bed", 5), 1, 2, new DateTime(2021, 11, 28, 9, 0, 0), 60));
