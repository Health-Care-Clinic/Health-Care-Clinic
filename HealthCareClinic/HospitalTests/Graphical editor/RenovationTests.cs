    ...
    public class RenovationTests
    {
        private DbContextOptions<HospitalDbContext> CreateStubRepository()
        {
            ...
            using (var context = new HospitalDbContext(options))
            {
                ...
                context.Transfer.Add(new Transfer { Id = 3, Equipment = new EquipmentForTransfer("Blanket", 7), RoomsForTransfer = new RoomsForTransfer(1, 2), DateAndDuration = new DateAndDuration(new DateTime(2021, 12, 25, 15, 30, 0), 45) });
