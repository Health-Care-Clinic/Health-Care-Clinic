    ...
    public class TransfersTests
    {
        private DbContextOptions<HospitalDbContext> CreateStubRepository()
        {
            ...
            using (var context = new HospitalDbContext(options))
            {
                ...
                context.Transfer.Add(new Transfer { Id = 3, Equipment = "Blanket", Quantity = 7, SourceRoomId = 1, DestinationRoomId = 2, Date = new DateTime(2021, 12, 30, 15, 30, 0), Duration = 45 });
