...
namespace HospitalUnitTests.Patient_portal
{
    public class AuthorizationTests
    {
        ...
        public void Success_login()
        {
            ...
            Assert.Equal("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjciLCJyb2xlIjoicGF0aWVudCJ9.FtOrWDpyT84TL1NT8TyTzRR4zLTR4mRKkJXzL1JDv9Y", response);
        }
        ...
        private static IPatientService CreateStubPatientService()
        {
            ...
            stubService.Setup(m => m.FindByUsernameAndPassword("miki", "miki")).Returns(patient);
