...
{
    public partial class ReportAndPrescriptionAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pacijent se zali na tegobe sa mucninom i bolom u stomaku", new DateTime(2022, 1, 22, 7, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, "Pacijent se zali na zubobolju", new DateTime(2021, 2, 22, 11, 30, 0, 0, DateTimeKind.Unspecified) },
                    { 2, "Pacijent se zali na tegobe sa glavoboljom", new DateTime(2022, 1, 12, 8, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, 26, new DateTime(2022, 1, 12, 8, 0, 0, 0, DateTimeKind.Unspecified), "Uzimati 3 put dnevno do poboljsanja", "Kafetin", 1, 400 },
                    { 2, 25, new DateTime(2022, 1, 22, 7, 0, 0, 0, DateTimeKind.Unspecified), "Uzimati 2 put dnevno do poboljsanja", "Brufen", 1, 200 },
                    { 1, 10, new DateTime(2022, 1, 5, 9, 0, 0, 0, DateTimeKind.Unspecified), "Uzimati 1 put dnevno do poboljsanja", "Panklav", 1, 300 }
                });
